	...
	//	content.add(deleteAccountPanel);
		...
		interestButton.addActionListener(ae -> {
			...
			else
			{
				...
				continueButton.addActionListener(ae12 -> {
					String euro = "\u20ac";
					 double interest = 0;
					 boolean loop1 = true;
					...
					if(in.isNumeric(interestString))
					{
		...
		//	content.removeAll();
			...
			saveButton.addActionListener(ae14 -> {
			...
			cancelButton.addActionListener(ae15 -> {
				f.dispose();
		...
		//	content.add(label1);
			...
			returnButton13.addActionListener(ae16 -> {
				f.dispose();
			admin();
			});
		});
		...
		navigateButton.addActionListener(ae -> {
			...
			previous.addActionListener(ae17 -> {
			...
			cancel.addActionListener(ae110 -> {
				dispose();
				admin();
					});
