	...
	public void admin()
	{
			...
			else
			{
				while(loop)
				{
					...
					else
					{
						...
						buttonPanel.add(returnButton13);
						Container content = f.getContentPane();
						content.setLayout(new GridLayout(2, 1));
						...
						else
						{
							...
							continueButton.addActionListener(ae112 -> {
								String euro = "\u20ac";
							...
							returnButton13.addActionListener(ae111 -> menuStart());
				...
				while(loop)
				{
					...
					else
					{
						...
						else
						{
							...
							continueButton.addActionListener(ae110 -> {
								String euro = "\u20ac";
								double interest;
								boolean loop1 = true;
								...
								while(loop1)
								{
									...
									if(IsNumeric.isNumeric(interestString))
									{
							...
							returnButton12.addActionListener(ae19 -> menuStart());
		...
		editCustomerButton.addActionListener(ae -> {
			...
			else
			{
				...
				saveButton.addActionListener(ae18 -> {
				...
				cancelButton.addActionListener(ae17 -> admin());
			}});
		...
		summaryButton.addActionListener(ae -> {
			...
			returnPanel1.add(returnButton1);
			...
			textPanel.add(returnButton1, BorderLayout.SOUTH);
			...
			returnButton1.addActionListener(ae15 -> admin());
		});
		...
		navigateButton.addActionListener(ae -> {
			...
			else
			{
				...
				first.addActionListener(ae16 -> {
					position = 0;
					setFieldZero();
				});

				previous.addActionListener(ae1 -> {
		...
		returnButton.addActionListener(ae -> menuStart());
	}
